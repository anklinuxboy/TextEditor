...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		// You can play around with this.
		int start = 50000;
		System.out.println("Characters\t" + "BasicDocument\t" + "EfficientDocument");
				...
				numToCheck += increment)
		{
			...
			double durationB = (double) durationBasic/1000000000;
			System.out.print(durationB + "\t");
			...
			long durationEff = endTimeEff - startTimeEff;
			double durationE = (double) durationEff/1000000000;
