...
public class NearbyWords implements SpellingSuggest {
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		while (!queue.isEmpty() && (retList.size() < numSuggestions) && (visited.size() < THRESHOLD)) {
			...
			List<String> preds = distanceOne(curr, true);
			for (String str : preds) {
   ...
   public static void main(String[] args) {
	   ...
	   List<String> l = w.distanceOne(word1, true);
	   //System.out.println("One away word Strings for for \""+word1+"\" are:");
